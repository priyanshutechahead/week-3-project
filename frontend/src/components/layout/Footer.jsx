    ...
    return (
      <footer className="border-t border-outline-variant pt-[24px] pb-[24px]">
        <div className="flex flex-col md:flex-row justify-between items-center max-w-[1280px] mx-auto px-[24px] w-full">
          <p className="text-body-sm text-secondary">© 2024 Discoverly. Distilled Intelligence.</p>
      ...
      <footer className="w-full py-8 border-t border-outline-variant bg-surface-container-lowest">
        <div className="max-w-[1280px] mx-auto flex flex-col md:flex-row justify-between items-center px-6 gap-4">
          <div className="flex items-center gap-4">
            <span className="text-label-caps font-label-caps text-on-surface-variant">© 2024 Discoverly. All rights reserved.</span>
          </div>
    ...
    <footer className="w-full py-[64px] mt-[64px] bg-surface-container-lowest border-t border-outline-variant">
      <div className="max-w-[1280px] mx-auto px-[24px] flex flex-col md:flex-row justify-between items-center gap-[24px]">
        <div className="flex flex-col items-center md:items-start">
          ...
          <p className="font-body-sm text-body-sm text-secondary mt-2">© 2024 Discoverly. Distilled Intelligence.</p>
        </div>
        <div className="flex flex-wrap justify-center gap-8">
          <a className="text-secondary hover:text-primary transition-all font-body-sm text-body-sm" href="#">Privacy Policy</a>
          <a className="text-secondary hover:text-primary transition-all font-body-sm text-body-sm" href="#">Terms of Service</a>
          <a className="text-secondary hover:text-primary transition-all font-body-sm text-body-sm" href="#">Security</a>
          <a className="text-secondary hover:text-primary transition-all font-body-sm text-body-sm" href="#">Contact</a>
        </div>
        <div className="flex gap-4">
          <a className="w-10 h-10 rounded-full border border-outline-variant flex items-center justify-center hover:bg-surface-container-low transition-colors" href="#">
